                ...
                <div  style=\"margin-top:7%;margin-bottom:2%;margin-left:5%;margin-right:5%;\">
                    <div class=\"row\">
                        <div class=\"col-md-4 offset-md-4 form pt-5 pb-3\">
                            <form action=\"user-otp_1.php\" method=\"POST\" autocomplete=\"off\">
        ...
        else
        {
            ...
            if(mysqli_num_rows($code_res) > 0)
            {
                ...
                if($update_res)
                {
                    ...
                    <div class=\"alert alert-success alert-dismissible\">
                        ...
                        <strong>Hi!</strong> $fname $lname, your email has been verified. <i class=\"fa fa-smile-o\"></i>.
                    </div>
            ...
            else
            {
                 echo "
                    ...
                    <div class=\"text-center\">
                        <a class=\"font-weight-bold text-dark\" href=\"http://localhost/railway/user-otp_1.php\">
