...
<body>
	<?php 
        ...
        if(mysqli_num_rows($res1) > 0)
        {
             echo "
                  <div class=\"alert alert-danger alert-dismissible\">
                      ...
                      <strong>Mobile Number already registered on website.Please use another mobile number</strong> <i class=\"fa fa-frown\"></i>.
                  </div>
                  <div class=\"text-center\">
                    <br>
                    <div class=\"text-center mt-3\">
        ...
        if($data_check)
        {
            ...
            if(mail($eid, $subject, $message, $sender))
            {
                ...
                header('location: user-otp_2.php');
                exit();
            }
            else
            {
	...
	<div class="text-center">
	  ...
	  <a class="font-weight-bold text-dark" href="http://localhost/railway/users_details.php">
			<button class="btn btn-danger" style="margin-left: 3%;">
