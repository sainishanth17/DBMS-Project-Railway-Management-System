                    ...
                    <div class=\"row\">
                        <div class=\"col-md-4 offset-md-4 form pt-5 pb-3\">
                            <form action=\"user-otp.php\" method=\"POST\" autocomplete=\"off\">
                                ...
                                <p class=\"text-center text-success\">Verification code has been sent to registered email address.</p>
        ...
        else
        {
            ...
            if(mysqli_num_rows($code_res) > 0)
            {
                ...
                if($update_res)
                {
                    ...
                    <div class=\"alert alert-success alert-dismissible\">
                        ...
                        <strong>Hi!</strong> $fname $lname, you have successfully Signed Up <i class=\"fa fa-smile-o\"></i>.
                    </div>
            ...
            else
            {
                 echo "
                    ...
                    <div class=\"text-center\">
                        <a class=\"font-weight-bold text-dark\" href=\"http://localhost/railway/user-otp.php\">
