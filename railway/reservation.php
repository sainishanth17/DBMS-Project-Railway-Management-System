...
<body>
    ...
    <?php 
        ...
        //echo " $doj $tno $class ".$_SESSION["sp"]." ".$_SESSION["dp"]." ";
         $query2 = mysqli_query($conn,"SELECT * FROM classseats WHERE classseats.journey_date= '$doj' AND classseats.train_number= $tno AND classseats.class_name= '$class' AND classseats.start_point= '".$_SESSION["sp"]."'  AND classseats.destination_point= '".$_SESSION["dp"]."'; ") or die(mysql_error());
