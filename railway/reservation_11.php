...
<body>
    ...
    <div class="text-center" style="margin-top:1%;">
        <?php
                echo"
                    <a href=\"http://localhost/railway/booking_result_11.php?doj=".$doj."&sp=".$_SESSION["sp"]."&dp=".$_SESSION["dp"]."\"  style=\" font-size:15px;margin-right:5%;margin-top:30px;\">
                         <i class=\"fa fa-arrow-left\"></i> Back
                    </a>
                      <a style=\" font-size:15px;margin-left:5%;margin-top:30px;\" href=\"http://localhost/railway/booking_history_1.php?mno=".$_SESSION["mobile_number"]."&password=".$_SESSION["password"]." \">
