...
<title>All Trains Information</title>
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="nav-item active">
					<a class="nav-link" href="#"><b>Train Details</b></a>
				</li>
				<li class="nav-item">
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-xs-6">
							<input type="text"  id="myInput" style="width:60%;color: black;" onkeyup="myFunction()" placeholder="Search using Train Name, Train Number">
						</div>
					</div>
				</div>
				<table class="table table-striped table-hover text-center table-bordered" id="myTable">
					<thead>
						<tr>
							...
							<th class="text-center">Desination Time</th>
							<th class="text-center">Arrival Day</th>
							<th class="text-center">Distance</th>
							<th class="text-center">Train Information</th>
						</tr>
					</thead>
					<tbody>
						<?php
							...
							$cdquery="SELECT * FROM train_details";
								...
								echo "
										<tr>
											...
											<td>
												...
												<a href=\"http://localhost/railway/train_schedule.php?trainno=".$cdrow['train_number']."\">
													<button class=\" btn btn-sm text-dark rounded btn-info\">Information</button>
												</a>
											</td>
											</tr>
									";
