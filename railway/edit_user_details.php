		...
		{ 
			...
			echo "
								<tr>
									...
									<form action=\"edit_user_details.php?id=".$_GET["id"]."\" method=\"post\">
									...
									<td style=\"text-align:center;\"><input style=\"text-align:center;\"type=\"email\" name=\"emailid\" value=\"".$cdrow["emailid"]."\" required></td>
									<td style=\"text-align:center;\"><input type=\"text\" style=\"text-align:center;\" name=\"password\" value=\"".$cdrow["password"]."\" required></td>
									<td style=\"text-align:center;\"><input type=\"text\" style=\"text-align:center;\"pattern=\"[0-9]{10}\" onkeypress=\"return onlyNumberKey(event)\" name=\"mobileno\" value=\"".$cdrow["mobile_number"]."\" required></td>
