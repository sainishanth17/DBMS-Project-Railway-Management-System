...
<body>
    ...
    ";
    $cdquery1="SELECT * FROM cancel_ticket WHERE pnr_number='".$_GET["pnr_no"]."'";
    $cdresult1=mysqli_query($conn,$cdquery1);
    while ($cdrow1=mysqli_fetch_array($cdresult1)) 
    {

      echo "
              <p style=\"text-align:center; font-size:20px; margin-top:-25px;margin-bottom:35px;\"><b>Refund Amount :</b> Rs ".$cdrow1['ticket_fare']."</p>
        ";
      }
	?>
	    <div class="text-center">
        <a href="http://localhost/railway/user_booking_history_1.php" class=" text-dark font-weight-bold">
