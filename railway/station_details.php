		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="nav-item active">
					<a class="nav-link" href="#"><b>Stations Details</b></a>
				</li>
				<li class="nav-item">
		...
		<div class="table table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-3">
							<h2>ALL Station Details</h2>
						</div>
						<div class="col-xs-9">
							<input type="text"  id="myInput" style="width:60%;color: black;" onkeyup="myFunction()" placeholder="Search using Station Name, Station Id">
							<a href="http://localhost/railway/add_station.php" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Add New Station</span></a>						
						</div>
					</div>
				</div>
				<table class="table table-striped table-hover text-center table-bordered" id="myTable">
					...
					<tbody>
						<?php
							...
							$cdquery="SELECT station_id,station_name FROM station_details";
							$cdresult=mysqli_query($conn,$cdquery);
							$x=1;
							while ($cdrow=mysqli_fetch_array($cdresult)) 
							{
					 			$cdId=$cdrow['station_id'];
					 			...
					 			echo "
										<tr>
											...
											<td>$cdTitle</td>
											<td>
												<a href=\"http://localhost/railway/edit_station_details.php?id=".$cdId."\"
													class=\"edit\" data-toggle=\"modal\">
													<i class=\"material-icons\" data-toggle=\"tooltip\" title=\"Edit\">&#xE254;</i>
												</a>
												<a href=\"http://localhost/railway/delete_station.php?id=".$cdId."\" class=\"delete\" data-toggle=\"modal\"><i class=\"material-icons\" data-toggle=\"tooltip\" title=\"Delete\">&#xE872;</i></a>
											</td>
										</tr>
								";
								$x+=1;							
