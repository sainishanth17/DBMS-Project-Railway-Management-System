...
<body >
  <?php 
    ...
    if($sp == $dp)
    {
      echo "
              ...
              <div class=\"text-center\">
                <a href=\"http://localhost/railway/book_ticket_1.php\" class=\" text-dark font-weight-bold\">
    ...
    else
    {
      ...
      ";
      $result = mysqli_query($conn,"SELECT  distinct t.train_number FROM train_details as t,classseats as c, train_schedule as s1,train_schedule as s2 where s1.train_number=t.train_number AND s2.train_number=t.train_number AND s1.station_name='".$sp."' AND s2.station_name='".$dp."' AND t.train_number=c.train_number AND c.start_point='".$sp."' AND c.destination_point='".$dp."' AND c.journey_date='".$doj."' ");
      ...
      echo"
                  ...
                  <div class=\"form-group\">
                    <div class=\"input-group\">
                      <span class=\"input-group-addon font-weight-bold\"><i style=\"font-size: 20px;width: 15px;\" class=\"fa fa-wheelchair\"></i></span>
