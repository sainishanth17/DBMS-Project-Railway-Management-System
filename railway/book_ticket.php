...
<body style="background-image: url(images/irctc.jpg);background-repeat: no-repeat;background-size: cover;background-attachment: fixed;background">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active">
          <a class="nav-link" href="#"><b>Find Train</b></a>
        </li>
        <li class="nav-item">
  ...
  <div class="login-form">
    <form action="http://localhost/railway/booking_result.php" method="post">
        <div class="avatar">
